...
function udesly_dare_to_surpass_setup()
{
    /*
...
add_action("after_setup_theme", "udesly_dare_to_surpass_setup");
...
function define_post_types_for_dare_to_surpass()
{
    if (!function_exists("udesly_define_post_type")) {
        return;
    }

    udesly_define_post_type("project", [
        "labels" => [
            "name" => __("Projects"),
...
add_action("init", "define_post_types_for_dare_to_surpass");
...
add_action("acf/init", function () {
    ...
    udesly_register_custom_fields_for_post_type("project", [
        ...
        udesly_custom_field_post_relation([
            "name" => "next-project",
            "label" => "Next Project",
            "instructions" => "",
            "post_type" => [
